...
from .dependencies import attach_author_service
...
async def get_all_authors(
    author_service: AuthorService = Depends(attach_author_service),
):
...
async def get_author_by_id(
    author_id: int, author_service: AuthorService = Depends(attach_author_service)
):
